...
local theme = lush(function()
    return {
        Black {fg = colours.black}, BlackItalic {Black, gui = "nocombine,italic"},
        BlackBG {bg = colours.black}, Blue {fg = colours.blue},
        BlueItalic {Blue, gui = "nocombine,italic"}, BlueBG {bg = colours.blue},
        Cyan {fg = colours.cyan}, CyanItalic {Cyan, gui = "nocombine,italic"},
        CyanBG {bg = colours.cyan}, Green {fg = colours.green},
        GreenItalic {Green, gui = "nocombine,italic"}, GreenBG {bg = colours.green},
        Grey {fg = colours.grey}, GreyItalic {Grey, gui = "nocombine,italic"},
        GreyBG {bg = colours.grey}, Orange {fg = colours.orange},
        OrangeItalic {Orange, gui = "nocombine,italic"}, OrangeBG {bg = colours.orange},
        Purple {fg = colours.purple}, PurpleItalic {Purple, gui = "nocombine,italic"},
        PurpleBG {bg = colours.purple}, Red {fg = colours.red},
        RedItalic {Red, gui = "nocombine,italic"}, RedBG {bg = colours.red},
        White {fg = colours.white}, WhiteItalic {White, gui = "nocombine,italic"},
        WhiteBG {bg = colours.white}, Yellow {fg = colours.yellow},
        YellowItalic {Yellow, gui = "nocombine,italic"}, YellowBG {bg = colours.yellow},

        LightBlack {fg = colours.lightBlack},
        LightBlackItalic {LightBlack, gui = "nocombine,italic"},
        LightBlackBG {bg = colours.lightBlack}, LightBlue {fg = colours.lightBlue},
        LightBlueItalic {LightBlue, gui = "nocombine,italic"},
        LightBlueBG {bg = colours.lightBlue}, LightCyan {fg = colours.lightCyan},
        LightCyanItalic {LightCyan, gui = "nocombine,italic"},
        LightCyanBG {bg = colours.lightCyan}, LightGreen {fg = colours.lightGreen},
        LightGreenItalic {LightGreen, gui = "nocombine,italic"},
        LightGreenBG {bg = colours.lightGreen}, LightGrey {fg = colours.lightGrey},
        LightGreyItalic {LightGrey, gui = "nocombine,italic"},
        LightGreyBG {bg = colours.lightGrey}, LightOrange {fg = colours.lightOrange},
        LightOrangeItalic {LightOrange, gui = "nocombine,italic"},
        LightOrangeBG {bg = colours.lightOrange}, LightPurple {fg = colours.lightPurple},
        LightPurpleItalic {LightPurple, gui = "nocombine,italic"},
        LightPurpleBG {bg = colours.lightPurple}, LightRed {fg = colours.lightRed},
        LightRedItalic {LightRed, gui = "nocombine,italic"},
        LightRedBG {bg = colours.lightRed}, LightWhite {fg = colours.lightWhite},
        LightWhiteItalic {LightWhite, gui = "nocombine,italic"},
        LightWhiteBG {bg = colours.lightWhite}, LightYellow {fg = colours.lightYellow},
        LightYellowItalic {LightYellow, gui = "nocombine,italic"},
        LightYellowBG {bg = colours.lightYellow}, Ignore {},
        ...
        Label {fg = colours.red, gui = "nocombine"}, Macro {Define},
        ...
        LspDiagnosticsSignError {fg = colours.red, gui = "nocombine,bold"},
        LspDiagnosticsSignHint {fg = colours.lightGreen, gui = "nocombine,bold"},
        LspDiagnosticsSignInformation {fg = colours.lightBlue, gui = "nocombine,bold"},
        LspDiagnosticsSignWarning {fg = colours.yellow, gui = "nocombine,bold"},
        LspDiagnosticsUnderlineError {Underlined, sp = colours.red},
        LspDiagnosticsUnderlineHint {Underlined, sp = colours.lightGreen},
        LspDiagnosticsUnderlineInformation {Underlined, sp = colours.lightBlue},
        LspDiagnosticsUnderlineWarning {Underlined, sp = colours.yellow},
