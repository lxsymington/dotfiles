...
local colours = {
    ...
    orange = hsl(20, 75, 40), -- original "#ec722f"
    purple = hsl(260, 60, 45), -- original "#673a5b"
    ...
    lightOrange = hsl(25, 100, 60), -- original "#fe882e"
    lightPurple = hsl(260, 45, 60), -- original "#9f7195"
    lightRed = hsl(0, 45, 60), -- original "#c5696e"
