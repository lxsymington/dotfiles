...
local theme = lush(function()
	return {
		...
		DiagnosticUnderlineError({ Underlined, sp = colours.red }),
		DiagnosticUnderlineHint({ Underlined, sp = colours.lightGreen }),
		DiagnosticUnderlineInfo({ Underlined, sp = colours.lightBlue }),
		DiagnosticUnderlineWarn({ Underlined, sp = colours.yellow }),
