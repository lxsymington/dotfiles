...
" Last Updated: Tue Oct 20 17:34:09 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    hi Cursor guifg=fg guibg=NONE gui=reverse cterm=reverse
    hi CursorColumn guifg=fg guibg=#222035 gui=NONE cterm=NONE
    hi CursorLine guifg=fg guibg=#222035 gui=NONE cterm=NONE
    ...
    hi Visual guifg=fg guibg=#5e723f gui=NONE cterm=NONE
    hi VisualNOS guifg=fg guibg=#83a0c8 gui=NONE cterm=NONE
    ...
    hi Constant guifg=#fff5af guibg=NONE gui=NONE cterm=NONE
    hi Error guifg=#fff5af guibg=#111224 gui=reverse cterm=reverse
    hi Identifier guifg=#354e39 guibg=NONE gui=NONE cterm=NONE
    hi Ignore guifg=#533861 guibg=NONE gui=NONE cterm=NONE
    hi PreProc guifg=#fff5af guibg=NONE gui=NONE cterm=NONE
    hi Special guifg=#fff5af guibg=NONE gui=NONE cterm=NONE
    hi Statement guifg=#fff5af guibg=NONE gui=NONE cterm=NONE
    hi Todo guifg=#fff5af guibg=NONE gui=NONE cterm=NONE
    hi Type guifg=#fff5af guibg=NONE gui=NONE cterm=NONE
    hi Underlined guifg=#fff5af guibg=NONE gui=NONE cterm=NONE
  ...
  " Light background
  let g:terminal_ansi_colors = ['#53585f', '#ff0000', '#00ff00', '#ffff00',
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi Cursor ctermfg=fg ctermbg=NONE cterm=reverse
    hi CursorColumn ctermfg=fg ctermbg=235 cterm=NONE
    ...
    hi Visual ctermfg=fg ctermbg=65 cterm=NONE
    hi VisualNOS ctermfg=fg ctermbg=110 cterm=NONE
    ...
    hi Error ctermfg=229 ctermbg=233 cterm=reverse
    ...
    hi Todo ctermfg=229 ctermbg=NONE cterm=NONE
    hi Type ctermfg=229 ctermbg=NONE cterm=NONE
    hi Underlined ctermfg=229 ctermbg=NONE cterm=NONE
...
if s:t_Co >= 8
  if &background ==# 'dark'
    ...
    hi Conceal ctermfg=NONE ctermbg=NONE cterm=NONE
    hi Cursor ctermfg=fg ctermbg=NONE cterm=reverse
    hi CursorColumn ctermfg=fg ctermbg=DarkGrey cterm=NONE
    hi CursorLine ctermfg=fg ctermbg=DarkGrey cterm=NONE
    ...
    hi Visual ctermfg=fg ctermbg=LightGreen cterm=NONE
    hi VisualNOS ctermfg=fg ctermbg=LightCyan cterm=NONE
